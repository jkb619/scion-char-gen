...
Output: scripts/interactive_sheet_fields_manifest.json (for pdf-lib / export tooling).
"""
...
OUT = ROOT / "scripts" / "interactive_sheet_fields_manifest.json"
...
def main() -> None:
    manifest: dict[str, object] = {
        "_meta": {
            "note": "AcroForm fields per PDF page: [fieldName, fieldType]. Regenerate: python3 scripts/export_interactive_sheet_field_manifest.py"
        }
    }
