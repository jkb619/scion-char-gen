...
def main() -> int:
    ...
    prev = ROOT / "data" / "knacksSaintsMonsters.json"
    titanic: dict = {}
    if prev.is_file():
    ...
    (ROOT / "data" / "knacksSaintsMonsters.json").write_text(
    ...
    (ROOT / "data" / "purviewsDenizens.json").write_text(
    ...
    (ROOT / "data" / "boonsSaintsMonsters.json").write_text(
    ...
    (ROOT / "data" / "epicenters.json").write_text(
